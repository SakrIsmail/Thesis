...
def create_new_annotations(json_file, output_json_file):
    """
    Processes the annotations from the given JSON file, filtering out specific images
    and organizing the data into a new structure.
    Args:
        json_file (str): Path to the input JSON file containing annotations.
        output_json_file (str): Path to the output JSON file where processed annotations will be saved.
    """
    excluded_images = {
        "50191.jpg",
        "50825.jpg",
    ...
    annotations_with_parts = {"all_parts": list(all_parts), "images": image_annotations}
...
output_json_file = "data/processed/new_annotations.json"
